/* ============================================
   POKEMON SPRITE LOADER - Nuzlocke Tracker
   Auto-adds official-style sprites next to Pokemon names
   Add to any page: <script src="pokemon-sprites.js"></script>
   
   Sprites from PokeAPI (community sprites project)
   Pokemon is property of Nintendo/Game Freak/Creatures Inc.
   ============================================ */
(function(){
  'use strict';

  // Pokemon name -> National Dex number mapping
  var DEX={
    ...
    "Farfetch'd":83,"Doduo":84,"Dodrio":85,"Seel":86,"Dewgong":87,"Grimer":88,"Muk":89,
    ...
    "Goldeen":118,"Seaking":119,"Staryu":120,"Starmie":121,"Mr. Mime":122,"Scyther":123,
    ...
    "Aerodactyl":142,"Snorlax":143,"Dratini":147,"Dragonair":148,"Dragonite":149,
    ...
    "Ariados":168,"Crobat":169,"Togepi":175,"Togetic":176,"Mareep":179,"Flaaffy":180,
    ...
    "Sunkern":191,"Sunflora":192,"Wooper":194,"Quagsire":195,"Espeon":196,"Umbreon":197,
    "Murkrow":198,"Slowking":199,"Misdreavus":200,"Unown":201,"Girafarig":203,
    ...
    "Heracross":214,"Sneasel":215,"Teddiursa":216,"Ursaring":217,"Slugma":218,
    "Magcargo":219,"Swinub":220,"Piloswine":221,"Corsola":222,"Remoraid":223,
    "Octillery":224,"Delibird":225,"Skarmory":227,"Houndour":228,"Houndoom":229,
    "Kingdra":230,"Phanpy":231,"Donphan":232,"Stantler":234,"Smeargle":235,
    "Tyrogue":236,"Hitmontop":237,"Smoochum":238,"Elekid":239,"Magby":240,
    "Miltank":241,"Larvitar":246,"Pupitar":247,"Tyranitar":248,
    ...
    "Pelipper":279,"Ralts":280,"Kirlia":281,"Gardevoir":282,"Surskit":283,
    "Masquerain":284,"Shroomish":285,"Breloom":286,"Slakoth":287,"Vigoroth":288,
    "Slaking":289,"Nincada":290,"Ninjask":291,"Shedinja":292,"Whismur":293,"Loudred":294,
    "Exploud":295,"Makuhita":296,"Hariyama":297,"Nosepass":299,"Skitty":300,
    "Delcatty":301,"Sableye":302,"Mawile":303,"Aron":304,"Lairon":305,"Aggron":306,
    ...
    "Carvanha":318,"Sharpedo":319,"Wailmer":320,"Wailord":321,"Numel":322,
    "Camerupt":323,"Torkoal":324,"Spoink":325,"Grumpig":326,"Spinda":327,"Trapinch":328,
    "Vibrava":329,"Flygon":330,"Cacnea":331,"Cacturne":332,"Swablu":333,"Altaria":334,
    "Zangoose":335,"Seviper":336,"Lunatone":337,"Solrock":338,"Barboach":339,
    "Whiscash":340,"Corphish":341,"Crawdaunt":342,"Baltoy":343,"Claydol":344,
    ...
    "Dusclops":356,"Tropius":357,"Chimecho":358,"Absol":359,"Snorunt":361,"Glalie":362,
    "Spheal":363,"Sealeo":364,"Walrein":365,"Clamperl":366,"Huntail":367,"Gorebyss":368,
    "Relicanth":369,"Luvdisc":370,"Bagon":371,"Shelgon":372,"Salamence":373,
    ...
    "Kricketune":402,"Shinx":403,"Luxio":404,"Luxray":405,"Budew":406,"Roserade":407,
    "Cranidos":408,"Rampardos":409,"Shieldon":410,"Bastiodon":411,"Burmy":412,
    "Wormadam":413,"Mothim":414,"Combee":415,"Vespiquen":416,"Pachirisu":417,
    "Buizel":418,"Floatzel":419,"Cherubi":420,"Cherrim":421,"Shellos":422,
    "Gastrodon":423,"Drifloon":425,"Drifblim":426,"Buneary":427,"Lopunny":428,
    "Mismagius":429,"Honchkrow":430,"Glameow":431,"Purugly":432,"Stunky":434,
    "Skuntank":435,"Bronzor":436,"Bronzong":437,"Gible":443,"Gabite":444,"Garchomp":445,
    ...
    "Lumineon":457,"Snover":459,"Abomasnow":460,"Weavile":461,"Magnezone":462,
    "Electivire":466,"Magmortar":467,"Togekiss":468,"Yanmega":469,"Leafeon":470,
    "Glaceon":471,"Gliscor":472,"Mamoswine":473,"Gallade":475,"Probopass":476,
    "Dusknoir":477,"Froslass":478,"Spiritomb":442,
    ...
    "Klinklang":601,"Eelektrik":603,"Eelektross":604,"Elgyem":605,"Beheeyem":606,
    ...
    "Barbaracle":689,"Skrelp":690,"Dragalge":691,"Clauncher":692,"Clawitzer":693,
    "Helioptile":694,"Heliolisk":695,"Tyrunt":696,"Tyrantrum":697,"Amaura":698,
    "Aurorus":699,"Hawlucha":701,"Dedenne":702,"Carbink":703,"Goomy":704,
    "Sliggoo":705,"Goodra":706,"Phantump":708,"Trevenant":709,"Pumpkaboo":710,
    "Gourgeist":711,"Noibat":714,"Noivern":715,
    ...
    "Pyukumuku":771,"Minior":774,"Komala":775,"Turtonator":776,"Togedemaru":777,
    "Mimikyu":778,"Bruxish":779,"Drampa":780,"Dhelmise":781,"Jangmo-o":782,
    "Hakamo-o":783,"Kommo-o":784
  };

  var SPRITE_URL = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/';
  ...
  css.textContent = [
    ...
    '.ac-sprite{width:28px;height:28px;image-rendering:pixelated}'
  ].join('\n');
  ...
  function getSprite(name) {
    var id = DEX[name];
    if (!id) return '';
    return '<img class="poke-sprite" src="' + SPRITE_URL + id + '.png" alt="' + name + '" loading="lazy" onerror="this.style.display=\'none\'">';
  }

  function getSmallSprite(name) {
    var id = DEX[name];
    if (!id) return '';
    return '<img class="ac-sprite" src="' + SPRITE_URL + id + '.png" alt="' + name + '" loading="lazy" onerror="this.style.display=\'none\'">';
  }

  // Observe DOM changes to add sprites to dynamically rendered content
  function addSprites(root) {
    // Encounter list items
    ...
    // Team slots
    var slots = root.querySelectorAll('.slot.filled');
    slots.forEach(function(slot) {
      if (slot.querySelector('.poke-sprite')) return;
      var sname = slot.querySelector('.sname');
      if (!sname) return;
      var sdetail = slot.querySelector('.sdetail');
      var pokeName = sname.textContent;
      // If there's a detail with the real name
      if (sdetail) {
        var parts = sdetail.textContent.split(' · ');
        if (parts.length > 1) pokeName = parts[0];
      }
      var sprite = getSprite(pokeName);
      if (sprite) {
        slot.insertAdjacentHTML('afterbegin', sprite);
      }
    });
  }

  // Patch autocomplete to show sprites
  function patchAutocomplete() {
    var origInput = window.onPokeInput;
    if (!origInput) return;
    
    window.onPokeInput = function() {
      origInput();
      // Add sprites to autocomplete items
      var list = document.getElementById('acList');
      if (!list) return;
      var items = list.querySelectorAll('.ac-item');
      items.forEach(function(item) {
        if (item.querySelector('.ac-sprite')) return;
        var name = item.textContent;
        var sprite = getSmallSprite(name);
        if (sprite) {
          item.innerHTML = sprite + name;
        }
      });
    };
  }
  ...
  function run() {
    ...
    if (tracker) {
      ...
      // Watch for changes (new encounters added, status changes, etc.)
      var observer = new MutationObserver(function() {
        addSprites(tracker);
      });
      observer.observe(tracker, { childList: true, subtree: true });
    }
  }
